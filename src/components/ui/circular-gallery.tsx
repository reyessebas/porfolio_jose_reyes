        ...
        >
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="relative w-full h-full rounded-lg shadow-2xl overflow-hidden group border border-border dark:border-gray-900 bg-card/70 dark:bg-card/30 backdrop-blur-lg">
                  {isVideo ? (
                    <video
                      src={item.photo.url}
